...
<html lang="en">
  ...
  <section id="main-content">
        <section class="wrapper site-min-height">
            <h4><i class="glyphicon glyphicon-file"></i><a href="<?php echo base_url();?>WMS" title="List of PR Approval" style="color:#004D40;padding-left:5px;font-size:15px;">Pending PR</a>
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="hidden-phone">PR NO.</th>
											    <th class="hidden-phone" ><i class="fa fa-calendar"></i> DATE PUCHASE CREATED</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="spareitems">
                                            ...
                                            <td>
												...
												<form method="post" action="<?php echo base_url();?>WMS/PR_Approval_Info">
												...
												<button type="submit" class="btn btn-link btn-link-modal" style="text-decoration:none;text-indent:20px;"> 
													<?php echo date('F d , Y',strtotime($row->date))." - ".date('h:i A', strtotime($row->date)); ?>
												</button>
												
												</form>
											</td>
                                            
                                            <td style="text-indent:20px;"><span class="label label-info" style="font-size:12px;text-transform:capitalize;"><?php echo $row->status; ?></span></td>
