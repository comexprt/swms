      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper site-min-height">
          	<h4><i class="glyphicon glyphicon-file"></i><a href="<?php echo base_url();?>WMS/Purchase_Approved" title="List of Approved Pre-PR" style="color:#004D40;padding-left:5px;font-size:15px;">Purchase Request</a>
			<i class="fa fa-angle-double-left" style="padding-left:5px;"></i><a style="color:#004D40;padding-left:5px;font-size:16px;">Approved</a>
			...
			<?php }?>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="margin-top:10px;">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1 spare-new-left-button" style="margin-top:10px;">
							...
							<button class="btn btn-lg" style="font-size:16px;border-radius:8px;float:right" title="Send Pre-PR DRAFT for Approval" >
								Waiting Procurement Officer
							</button>
						</div><!-- col-lg-4 -->
...
<?php foreach ($DraftInfo as $row){?>			
			<div class="modal fade" id="<?php echo $row->SpId;?>createPO" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						    <center><h5 class="modal-title" id="myModalLabel">Create Purchase Order</h5></center>
						</div>
