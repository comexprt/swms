      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper site-min-height">
          	<h4 class="noprint"><i class="fa fa-shopping-cart"></i><a href="<?php echo base_url();?>WMS/Approve_PR" title="List of Approved PR" style="color:#004D40;padding-left:5px;font-size:15px;">Approved PR</a>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="margin-top:10px;">
                                    ...
                                    <thead>
                                        <tr style="background-color:#EEEEEE;">
											  ...
											  <th style="border:1px solid #24665B;" class="noprint"><center>SETUP</center></th>
									...
									<?php 
									 ...
									 ?>
                                        <tr>
											...
											<?php
											$count =0;
												foreach ($getLastBidInfo as $row1){
													$bprid=$row1->prid;
													$bwsid=$row1->wsid;
													if ($row->prid == $bprid && $row->wsid==$bwsid){
														$count ++ ;
													}else{}
												}
											?>
											<td class="noprint"  style="border:1px solid #24665B;">
												<center><?php if ($count == 0){ ?>
											...
											<form method="post" action="<?php echo base_url();?>WMS/Bidding_Set_Info">
												...
												<button type="submit"  class="btn btn-danger btn-xs" style="text-decoration:none;font-size:13px;font-weight:bold;"> 
													Bidding Set
												</button></form>
											<?php } ?>
												</center>
