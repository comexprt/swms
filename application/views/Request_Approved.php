      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper site-min-height">
			...
			<i class="fa fa-angle-double-left" style="padding-left:5px;"></i><a style="color:#004D40;padding-left:5px;font-size:16px;">Release</a></h4>
          	<div class="row mt">
          		<div class="col-lg-12">
					<div class="col-lg-12">
                                ...
                                <table class="table table-striped table-advance table-hover" id="dataTables-Requested">
                                        ...
                                        <tr>
                                            ...
                                            <th>PURPOSE</th>
											    <th class="hidden-phone" ><i class="fa fa-calendar"></i> DATE REQUESTED</th>
												 <th><i class="fa fa-tags"></i> Release</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="spareitems">
											...
											<?php if ($row->status == 'Approved'){echo "<center>- - - - - -</center>";}else{ ?>
											<center><span class="label label-success" style="font-size:12px;"><?='Approved';?>
											</span>
											</center>
											<?php } ?>
											</td>
											...
											<td>
											<center>
													<form method="post" action="<?php echo base_url();?>WMS/Spare_Approved_Info">
