      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		...
		<h4><i class="glyphicon glyphicon-stats"></i><a href="<?php echo base_url();?>WMS/Bidding" title="List of Bidding PR" style="color:#004D40;padding-left:5px;font-size:15px;">Bidding PR</a></i>
			...
			<a style="color:#004D40;padding-left:5px;font-size:16px;"><?php echo "PR-".$PR_Date;?></a></i>
                                    ...
                                    <tbody>
									 ...
									 foreach ($SpareInfo as $row){ ?>
                                        ...
                                        <tr>
											...
											<?php  foreach ($BiddingInfoDetails as $row2){ 
											...
											<center>
											<button title="Add Quotation" type="button" style="color:#004d40;font-size:13px;" class="btn  btn-default link-modal" data-toggle="modal" data-target="#<?php echo $row->WSid;?>AddQuotation"><i class="glyphicon glyphicon-plus"></i> Quotation</button>
											<br>	
...
<?php foreach ($Category as $row){?>			
			<div class="modal fade" id="<?php echo $row->WSid;?>AddQuotation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<div class="modal-body" style="font-size:12px;color:#00271D;">
						   <?php echo form_open("WMS/editPR1");?>		
							<div class="row" style="width:80%;margin:0px auto;">
								<input  type="hidden" value="add-Bid" name="sms">
								<input  type="hidden" value="<?php  echo $PR_Date;?>" name="PR_Date">
								...
								<label style="font-weight:bold;font-size:12px;">Supplier</label>
										<br>
								<select name="SDceNo" class="form-control"> 
								<?php foreach ($SupplierInfo as $row1){?>
								
									<option value="<?php echo $row1->SDceNo; ?>"><?php echo $row1->Supplier_Name; ?></option>
								<?php } ?>
							  </select>
							  
							  <label style="font-weight:bold;font-size:12px;">Amount</label>
										<br>
										<input type="number" class="form-control"  name="Quotation" required/>
