      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        <section class="wrapper site-min-height">
			...
			</i><a style="color:#004D40;padding-left:5px;font-size:16px;">Requested Spares Withdrawal</a></h4>
          	<div class="row mt">
          		<div class="col-lg-12">
						<div class="panel-bodyt">
							<!-- Nav tabs -->
							<ul class="nav nav-tabs">
								<li class="active"><a href="#Draft" data-toggle="tab">Requested</a>
								</li>
								
								<li><a href="#Requested" data-toggle="tab">Evaluated</a>
								</li>
                                ...
                                <table class="table table-striped table-advance table-hover" id="dataTables-Draft">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="spareitems">
                                            ...
                                            <td><center><?php 
												if ($row->status == 'Pending' ){echo "<span class='label label-info' style='font-size:12px;'>".$row->status ."</span>";}
											...
											?></center></td>
											 ...
											 <?php 
												...
												<center><a href="#" role="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#<?=$row->wrid;?>viewWithdrawalRequest">
											...
											<?php }
												...
												<center><button type="submit" class="btn btn-default btn-xs" style="text-decoration:none;" title="Resume Draft">
													<?php echo"<i style='font-size:14px;' class='glyphicon glyphicon-share-alt' aria-hidden='true'></i>"; ?>
												</button></center>
												<?php }
											?>
                                            ...
                                            <td><?php echo $row->date_created;?></td>
											   ...
											   <?php 
												...
												<?php }else{ ?>
													...
													<td><center><span class="label label-default" style="font-size:12px;"><?php echo $row->status; ?></span><c/enter></td>
												<?php }?>
