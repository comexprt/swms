          	...
          	<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1">
										...
										<div class="spare-right-purpose">
											...
											<?php 
												...
												if( $Status == "Scheduled For Bidding"){ ?>
													<p>: <span class="label label-danger" style="font-size:12px;"><?php echo $Status; ?></span></p>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1" style="margin-top:10px;">
                                    ...
                                    <tbody>
									 ...
									 foreach ($SpareInfo as $row){ ?>
                                        <tr>
											...
											<td style="border:1px solid #24665B;"><p>
											<center><span style="font-weight:bold;font-size:13px;"><?php echo $row->qty." ".$row->unit_of_measurement;?></span>
											</center></p>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 spare-info spare-info1 spare-new-left-button" style="margin-top:10px;">
							...
							<?php if( $row->status != "Scheduled for Bidding"){ ?>
									...
									<button class="btn btn-lg" style="font-size:20px;border-radius:8px;float:left" title="Add to Bidding" data-toggle="modal" data-target="#<?php echo $row->date;?>Bid">
									 <i class="glyphicon glyphicon-stats"></i>
									<span>Bid</span>
									</button>												
...
<?php foreach ($draft3 as $row){?>			
			<div class="modal fade" id="<?php echo $row->date;?>Bid" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog" style="width:25%;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						    <h4 class="modal-title" id="myModalLabel">Confirm Bidding</h4>
						</div>
						...
						<div class="modal-body" style="font-size:12px;color:#00271D;">
							...
							<div class="row">
								...
								<input  type="hidden" value="Scheduled for Bidding" name="PR_Status">
								...
								<div class='col-md-12'>
									<div style="margin-left:1%;margin-top:8px;margin-bottom:12px;">
										...
										<label style="font-size:14px;font-weight:bold;">Are you sure to Bid PR ? </label>
									</div>
									<div style="margin-left:1%;margin-top:8px;margin-bottom:14px;font-size:12px;">
										<div style="margin-left:1%;margin-top:8px;">
										<label>Remarks </label>
										<br>
										<input type="date" class="form-control"  name="Date_b" required/>
										<br>
										<label>Time</label>
										<br>
										<input type="time" class="form-control"  name="Time_b" required/>
										<br>
										<label>Venue</label>
										<br>
										<input type="input" class="form-control"  name="Venue_b" required/>
				...
				<div class="modal-dialog" style="width:25%;">
					<div class="modal-content">
						...
						<div class="modal-body" style="font-size:12px;color:#00271D;">
						    <?php echo form_open("WMS/editPR1");?>	
							<div class="row">
								<input  type="hidden" value="cancel-confirm" name="sms">
								<input  type="hidden" value="<?php  echo $row->date;?>" name="PR_Date">
								<input  type="hidden" value="Pending" name="PR_Status">
								<input  type="hidden" value="<?php  echo $Fname[0].".".$Mname[0]." ".$Lname;?>" name="PR_responsible_person">
								...
								<div class='col-md-12'>
									<div style="margin-left:1%;margin-top:8px;margin-bottom:12px;">
										<div style="margin-left:1%;margin-top:8px;">
										<label style="font-size:14px;font-weight:bold;">Are you sure to Cancel Approved PR ? </label>
									</div>
