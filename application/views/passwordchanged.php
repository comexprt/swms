      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
				...
				<a href="<?php echo base_url();?>" style="font-size:10px;color:blue;text-decoration:underline;">LOGIN</a><br><br>
					You've Been LOGOUT !!  <br></br>
					Password was Successfully Changed. Hit LOGIN to verify.
